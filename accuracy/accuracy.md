...
This document describes the accuracy characteristics of the Insights by Omkar
astrology engine. Every claim below is backed by tests in
`lib/ephemeris/__tests__/accuracy-*.test.ts` that run in CI.
